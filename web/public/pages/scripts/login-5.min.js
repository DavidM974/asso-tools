var Login = function() {
    ...
    return{init: function() {
            r(), $(".login-bg").backstretch(["/workspace/intranet/web/public/pages/img/login/bg1.jpg", "/workspace/intranet/web/public/pages/img/login/bg2.jpg", "/workspace/intranet/web/public/pages/img/login/bg3.jpg"], {fade: 1e3, duration: 8e3}), $(".forget-form").hide()
        }}
}();
